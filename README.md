...
### Implementation
How to generate trajectory? <br/>

Everytime when we generate trajectory, we get the current position of the car from sensor fusion data, and extract two points of the previous trajectory before the current position. 
